...
Проект имеет набор тестов JUnit для проверки основной логики приложения. Текущее покрытие кода тестами составляет **44.2%**. Основное внимание уделено тестированию слоя доступа к данным (DAO) и модели, где покрытие превышает 85%. Пользовательский интерфейс (UI) в настоящее время не покрыт тестами.
